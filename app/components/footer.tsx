                    ...
                    <div className="mt-8 lg:grid lg:grid-cols-10 lg:gap-8 lg:mt-0">
                        <div className="lg:col-span-4">
                            <div>
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sit amet tortor erat. Nam nulla tortor, consectetur ultricies turpis sit amet, volutpat iaculis lacus.
                                </p>
